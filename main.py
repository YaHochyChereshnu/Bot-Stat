...
API_TOKEN = "5920470014:AAFXq9kv5rujWNRqZ0Va-MzxARUavQcZ7SY"
...
def stat(user_id, command):
    connection = pymysql.connect("sql.freedb.tech", "freedb_YaHochyChereshnu", "T6cksyH8%NrgH4Y", "freedb_YaHochyChereshnu")
